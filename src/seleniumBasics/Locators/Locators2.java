...
public class Locators2 {
	...
	public static String getPassword(WebDriver driver) throws InterruptedException
	{
		...
		//Please use terary password 'rahulshettyacademy' to Login.
		
		String[] passwordArray = pwdtext.split("'");
		String result = Arrays.toString(passwordArray);
		System.out.println(passwordArray[1]);

		//0th index = Please use temporampory password 
		//1st index = rahulshettyacademy' to Login.
		//System.out.println(passwordArray.toString());
